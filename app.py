...
most_important_features = feature_importance_name[0:50]
...
fig1 = fig_hist(test_df_predict, test_df_predict.columns[0], "Histogram plot for the features")
...
app.layout = html.Div(
    ...
    children=[
        ...
        html.Div(
            [
                html.H3(
                    "Data Visualization for Scoring with Dash",
...
def plot_histogram(x_data):
    figure = fig_hist(test_df_predict, x_data, "Histogram plot")
    return figure
